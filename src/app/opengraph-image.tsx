        ...
        (
            <div tw="flex w-full h-full bg-slate-900 items-center justify-center p-20">
                <div tw="flex flex-col items-center justify-center border-4 border-slate-700 rounded-3xl w-full h-full p-10 bg-slate-800 shadow-2xl">
                    ...
                    <div tw="text-white text-7xl font-bold tracking-tight text-center m-2 flex">
                        {profile.shortName}
                    </div>

                    <div tw="text-blue-400 text-4xl mt-6 text-center font-semibold m-2 flex">
                        {profile.title}
                    </div>

                    <div tw="text-slate-300 text-2xl mt-8 text-center max-w-2xl m-2 flex">
