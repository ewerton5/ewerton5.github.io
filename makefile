...
dentinho:
	...
	expo build:ios -t simulator --public-url https://ewerton5.github.io/apps/app-dentinho/ios-index.json
	expo build:android -t apk --public-url https://ewerton5.github.io/apps/app-dentinho/android-index.json
...
carlex-externo:
	...
	git push origin master
	expo build:ios -t simulator --public-url https://ewerton5.github.io/apps/app-carlex-externo/ios-index.json
	expo build:android -t apk --public-url https://ewerton5.github.io/apps/app-carlex-externo/android-index.json
...
carlex-interno:
	...
	git push origin master
	expo build:ios -t simulator --public-url https://ewerton5.github.io/apps/app-carlex-interno/ios-index.json
	expo build:android -t apk --public-url https://ewerton5.github.io/apps/app-carlex-interno/android-index.json
